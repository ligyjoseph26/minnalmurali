...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('💥 𝙾𝚆𝙽𝙴𝚁 💥', url='https://t.me/ptstark'), 
            InlineKeyboardButton('📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢', url='https://t.me/DTG_BOTZ')
            ],[      
        ...
        m=await message.reply_sticker("CAACAgUAAxkBAAIeM2KbCkETnqM14jq_jxuXLiO_se7EAAIVAQACyJRkFGZEMKKnFWwTHgQ") 
